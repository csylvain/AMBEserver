...
###############################################################################
#
#   AMBEtest5.py is based on AMBEtest4.py (written for python2)
#     found in Analog_Bridge
#     at https://github.com/DVSwitch/Analog_Bridge
#     which bore the id and timestamp "2017 Mike Zingman N4IRR"
#
#   AMBEtest4.py is based on AMBEtest2.py and AMBEtest3.py
#     found in OpenDV/DummyRepeater/DV3000
#     at https://github.com/dl5di/OpenDV/tree/master/DummyRepeater
#     author: DL5DI
#
###############################################################################
#
...
def main(argv):
    ...
    useSerial = True
    SERIAL_BAUD=230400
    serialport = "/dev/ttyAMA0" # GPIO device. use /dev/ttyUSB0 otherwise
    try:
